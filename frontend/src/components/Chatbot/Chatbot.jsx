...
//     return (
//         <div className="min-h-screen bg-green-50 flex flex-col items-center justify-start p-4">
//             <h1 className="text-2xl font-bold mb-4">🌾 Farmer Assistant Chatbot</h1>
...
//             <div className="w-full max-w-xl bg-white p-4 rounded shadow-md mb-4">
